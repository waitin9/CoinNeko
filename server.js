...
if (catCount.c === 0) {
  const cats = [
    ...
    { id: uuidv4(), name: '江戶川柯南', job_title: '偵探貓', rarity: 'epic', emoji: '🔍', description: '你以為不見的五十塊，其實都難逃牠的法眼。' },
    { id: uuidv4(), name: '阿姆斯壯', job_title: '太空人貓', rarity: 'epic', emoji: '🚀', description: '腦波極弱，只要看到特價，錢包經常呈現無重力狀態。' },
    { id: uuidv4(), name: '藝術喵', job_title: '畫家貓', rarity: 'rare', emoji: '🎨', description: '買顏料花錢如流水，只能把月底吃土的日常畫成悲傷油畫。' },
    { id: uuidv4(), name: '火車呼嚕嚕', job_title: '火車貓', rarity: 'common', emoji: '🚂', description: '每天精算1200通勤月票到底要搭幾次才回本的精明貓貓。' },
    ...
    { id: uuidv4(), name: '上下車都要刷卡', job_title: '公車貓', rarity: 'common', emoji: '🚌', description: '為了省十塊錢的捷運轉乘費，寧願多走十五分鐘的路。' },
    ...
    { id: uuidv4(), name: '不會開飛機', job_title: '機長貓', rarity: 'rare', emoji: '✈️', description: '出國玩絕對要搶到超便宜的紅眼廉航機票，算盤打得超精。' },
    { id: uuidv4(), name: '深海尋寶', job_title: '潛水貓', rarity: 'rare', emoji: '🤿', description: '總能在特賣會花車的最深處，精準挖到便宜又好看的衣服。' },
    { id: uuidv4(), name: '好多猩猩', job_title: '天文貓', rarity: 'rare', emoji: '🔭', description: '經常因為看星星看到忘我，不小心錯過末班車只好花大錢搭計程車。' },
    ...
    { id: uuidv4(), name: '酒流十家', job_title: '調酒貓', rarity: 'rare', emoji: '🍸', description: '下班後最喜歡去酒吧喝一杯，但結帳時看到帳單會瞬間清醒。' },

    // === 史詩級 (Epic) - 難以捉摸的高手貓咪 ===
    { id: uuidv4(), name: '追星狂粉', job_title: '追星貓', rarity: 'epic', emoji: '✨', description: '很喜歡 winter ，為了買小卡和演唱會門票連泡麵都願意吃。' },
    ...
    { id: uuidv4(), name: '非常bow欠', job_title: '弓箭手貓', rarity: 'epic', emoji: '🏹', description: '網購搶單手速極快，雙11的限量特價品絕對逃不出牠的手掌心。' },
    { id: uuidv4(), name: '忍者寧賈', job_title: '忍者貓', rarity: 'epic', emoji: '🥷', description: '喜歡把私房錢藏在極度隱密的地方，結果時間久了連自己都忘記放哪。' },
    { id: uuidv4(), name: '錢包太空', job_title: '太空貓', rarity: 'epic', emoji: '🚀', description: '買了超多虛擬貨幣夢想一飛衝天上太空，目前還在地球表面吃土。' },
    ...
    { id: uuidv4(), name: '發給我紅包', job_title: '財神貓', rarity: 'legendary', emoji: '🧧', description: '傳說中，每個月初能把你記帳本的錯誤爛帳一筆勾銷的神秘力量。' },
